#include "ftkMovingDualRamp3DSource.h"
...
vtkStandardNewMacro(ftkMovingDualRamp3DSource);

ftkMovingDualRamp3DSource::ftkMovingDualRamp3DSource() : 
  DW(21), DH(21), DD(21), DT(10), 
  X0(10.0), Rate(0.7), Offset(2.0)
{
...
int ftkMovingDualRamp3DSource::FillOutputPortInformation(int, vtkInformation *info)
{
  info->Set(vtkDataObject::DATA_TYPE_NAME(), "vtkImageData");
  return 1;
}

int ftkMovingDualRamp3DSource::RequestInformation(
    vtkInformation*, 
...
int ftkMovingDualRamp3DSource::RequestData(
    vtkInformation*, 
    ...
    vtkInformationVector* outputVector)
{
  ...
  auto scalar_field = ftk::synthetic_moving_dual_ramp<double, 3>(
      {(size_t)DW, (size_t)DH, (size_t)DD}, 
      X0, Rate, currentTime + Offset);
