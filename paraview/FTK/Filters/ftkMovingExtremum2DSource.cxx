#include "ftkMovingExtremum2DSource.h"
...
vtkStandardNewMacro(ftkMovingExtremum2DSource);
...
int ftkMovingExtremum2DSource::FillOutputPortInformation(int, vtkInformation *info)
{
  info->Set(vtkDataObject::DATA_TYPE_NAME(), "vtkImageData");
  return 1;
}

int ftkMovingExtremum2DSource::RequestInformation(
    vtkInformation*, 
...
int ftkMovingExtremum2DSource::RequestData(
    vtkInformation*, 
    ...
    vtkInformationVector* outputVector)
{
  ...
  auto scalar_field = ftk::synthetic_moving_extremum<double, 2>({(size_t)DW, (size_t)DH}, X0, Dir, currentTime);
