...
struct simplicial_unstructured_extruded_3d_mesh : public object { // extruded from 
  simplicial_unstructured_extruded_3d_mesh(std::shared_ptr<simplicial_unstructured_3d_mesh<I, F>> m_) : m(m_) {extrude();}
...
private:
  std::shared_ptr<simplicial_unstructured_3d_mesh<I, F>> m;
