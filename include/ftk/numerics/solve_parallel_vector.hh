...
template <typename ValueType>
inline bool solve_parallel_vector_barycentric(const ValueType V[3][3], const ValueType W[3][3], ValueType lambda[3])
{
  ...
  transpose3(VV);
  transpose3(WW);
  return solve_parallel_vector_barycentric(VV, WW, lambda);
}
